...
function App() {
  ...
  const handleToolChange = (tool: string | null, _hatched?: boolean) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isSidebarOpen && (
            <DocumentManagement onDocumentSelect={handleDocumentSelect} />
          )}
        </aside>
        ...
        >
          {selectedDocument ? (
            ...
            >
              ...
              <h2 style={{ margin: "0 0 8px 0", color: "#334155" }}>
                図面を選択してください
              </h2>
